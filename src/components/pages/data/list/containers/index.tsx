...
export default function ResponseListContainer() {
  return (
    ...
    >
      <CollapsablePane top="4.4rem" header={<FiltersHeader />} title={"Filters"} mobileTop="6.4rem">
        <Filters />
      </CollapsablePane>
      <CollapsablePane top="7.5rem" header={<CardHeader />} title={"List"} mobileTop="13.4rem">
        <Cards />
      </CollapsablePane>
      <NonCollapsablePane>
        <Map />
